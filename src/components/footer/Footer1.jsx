    ...
    <footer className="bg-dark position-relative overflow-hidden pb-0 pt-6 pt-lg-8" data-bs-theme="dark">
      ...
      <Container className="position-relative mt-5">
        <Row className="g-4 justify-content-between">
          <Col lg={3}>
            <LogoBox imageClassName="h-60px" className="me-0" />

            <p className="mt-4 mb-2">
              Acwad is a software company providing custom digital solutions and IT services to help businesses grow and innovate.
            </p>
          </Col>
          <Col lg={8} xxl={7}>
            <Row className="g-4">
              ...
              {/* App Avaliable and Social media Links */}
              {/* <Col md={4}>
