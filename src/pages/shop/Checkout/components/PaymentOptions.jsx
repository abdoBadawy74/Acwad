            ...
            return <Col md={6} lg={12} xl={6} key={idx}>
                  <div className="form-check border rounded p-3">
                    ...
                    <div className="d-flex justify-content-end gap-3 mt-3">
                      ...
                      {item.image && <Link to="" onClick={toggle} className="heading-color text-primary-hover fw-semibold small" data-bs-toggle="modal" data-bs-target="#editcard"><BsPencilSquare className="me-1" />Edit</Link>}
                    </div>
                  </div>
                </Col>;
          })}
