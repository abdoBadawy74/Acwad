        ...
        <Col xs={7} md={10}>
          <Row className="g-3 g-sm-4">
            ...
            <Col sm={6} md={4} xl={3} className="text-md-center">
              {product.sale ? <h5 className="mb-0">{currency}{getDiscountedPrice(product.price, product.sale.discount, product.sale.type)}</h5> : <h5 className="mb-0">{currency}{product.price.toFixed(2)}</h5>}
            </Col>
