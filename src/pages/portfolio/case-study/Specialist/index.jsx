                ...
                <div className="d-flex justify-content-center position-relative mb-4">
                  <PageBreadcrumb
                    ...
                    items={[
                      ...
                      { name: 'Specialist', url: '/portfolio/case-study/specialist' },
                    ]}
                  />
                </div>
                <h1 className="mb-4">الكيميائي | El-Kimyae App</h1>
                <p>The most powerful educational mobile app for interactive chemistry learning tailored for students in Egypt and the Arab world.</p>
              </Col>
