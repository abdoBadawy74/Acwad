  ...
  return (
    <section className="position-relative overflow-hidden pb-0 pt-xl-9">
      ...
      <figure className="position-absolute top-0 end-0 me-n4 mt-n7 d-none d-xl-block">
        <svg className="opacity-25" width="775px" height="834px" viewBox="0 0 775 834" xmlSpace="preserve" fill="#fbb304">
      ...
      <Container className="pt-4 pt-sm-5">
        <Row className="g-xl-5">
            ...
            <div className="pe-xxl-4">
              ...
              <h1 className="mt-3 lh-base">
                ...
                <span className="cd-headline clip big-clip is-full-width text-primary mb-0 d-block d-xxl-inline-block">
                  <ReactTyped
                    strings={['Mobile App', 'Web Design', 'Web Dev', 'UI/UX Design']}
                    className="typed"
                    typeSpeed={200}
                    backSpeed={50}
                    loop
              ...
              {/* <Col as={Form} md={10} className="bg-body border rounded-2 position-relative p-2 mt-4 mt-md-5">
                <InputGroup>
                  <Form.Control className="focus-shadow-none border-0 me-1" type="email" placeholder="Enter your email address" />
          ...
          <Col md={10} xl={5} className="position-relative mx-auto mt-7 mt-xl-0">
            ...
            <img src={bg1Img} className="rounded" alt="hero-img" />
            ...
            {/* <div className="d-inline-block card card-body shadow rounded-4 position-absolute end-0 top-0 p-3 me-lg-n3 me-xxl-n7 mt-n5 d-none d-sm-block">
              <img src={trustPilot} className="light-mode-item h-20px mb-2" alt="Client-img" />
              <img src={trustPilotLight} className="dark-mode-item h-20px mb-2" alt="Client-img" />
              <div className="d-flex align-items-center">
                <img src={trustPilotStar} className="h-30px" alt="rating-img" />
