          ...
          <Row className="g-4">
            ...
            <Col xs={12}>
              ...
              <div className="input-group">
                ...
                <TextFormInput type='text' defaultValue="Jacqueline" placeholder='First name' name='firstName' control={control} combined />

                <TextFormInput type='text' defaultValue="Miller" placeholder='Last name' name='lastName' control={control} combined />

              </div>
            </Col>

            <TextFormInput name='email' containerClass='col-md-6' label='Email address' defaultValue="hello@gmail.com" type='email' placeholder='Enter your email id' control={control} />

            <TextFormInput defaultValue="222 555 666" containerClass='col-md-6' placeholder='Enter your mobile number' name='mobile' label='Mobile number' control={control} />
