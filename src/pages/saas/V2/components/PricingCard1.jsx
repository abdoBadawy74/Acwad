...
const PricingCard1 = ({
  ...
  return <Card className="card-body bg-light p-4 p-sm-5">
            ...
            <Form className="mb-4">
                <Form.Control size='lg' className="focus-shadow-none bg-transparent border-0 border-bottom rounded-0 ps-0" type="email" placeholder="000" />
            </Form>
            ...
            <Link className="btn btn-primary icon-link icon-link-hover justify-content-center" to="">
