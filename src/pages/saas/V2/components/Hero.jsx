                ...
                <Row className="justify-content-xl-start justify-content-center flex-xl-nowrap">
                    <Col xl={6} className="ps-xl-5 mb-8 mb-xl-0">
                        ...
                        <Row className="g-4">
                            <Col sm={6}>
                                ...
                                <img src={trustpilotStar} className="h-20px mb-3" alt="Rating-img" />
                    ...
                    <Col xl={10} className="d-flex rotate-343 position-relative aos z-index-2" data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out">
                        ...
                        <Parallax>
                            ...
                            <div className="">
                                <img src={decoration1} data-depth="0.5" className="layer position-absolute top-0 end-0 rounded-3 h-25 shadow me-5" alt="" />
                            </div>


                            <img src={decoration2} className="rounded-3 shadow position-absolute top-0 start-50 translate-middle mt-7 d-none d-md-block" alt="" />


                            <img src={decoration3} data-depth="0.8" className="rounded-3 layer shadow position-absolute bottom-0 start-0 ms-8 d-none d-lg-block" alt="" />


                            <img src={decoration4} data-depth="0.3" className="rounded-3 layer shadow position-absolute bottom-0 end-0 me-9 mb-4 d-none d-sm-block" alt="" />
                        </Parallax>
