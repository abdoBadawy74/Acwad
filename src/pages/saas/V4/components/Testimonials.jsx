                        ...
                        <Card className="bg-dark p-4 p-sm-5 overflow-hidden h-100" data-bs-theme="dark">
                            ...
                            <Card.Footer className="bg-transparent p-0 z-index-1">
                                <Form className="input-group mb-2">
                                    <Form.Control size='lg' className="rounded border me-3" type="email" placeholder="Enter your email" />
                    ...
                    <Col xl={7} className="order-xl-2">
                        <Swiper className="overflow-hidden" {...swiperOptions}>
                            ...
                            <div className="d-flex gap-3">
                                <Link to="" className="btn btn-dark border btn-icon btn-lg rounded-circle mb-0 swiper-button-prev">
                                    <BsArrowLeft /></Link>
                                <Link to="" className="btn btn-dark border btn-icon btn-lg rounded-circle mb-0 swiper-button-next">
                                    <BsArrowRight /></Link>
                            </div>
