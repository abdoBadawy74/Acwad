                        ...
                        <Row>
                            <Col lg={11} xl={9} className="position-relative ms-auto">
                                ...
                                <ul className="list-inline bg-body d-flex flex-column rounded shadow position-absolute top-0 start-0 d-none d-sm-flex p-2 mb-0 mt-3 ms-xl-n5">
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-facebook" to="">
                                        <FaFacebookF className="fa-fw lh-base" /></Link></li>
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-instagram" to="">
                                        <FaInstagram className="fa-fw lh-base" /></Link></li>
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-twitter" to="">
                                        <FaTwitter className="fa-fw lh-base" /></Link></li>
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-linkedin" to="">
                                        <FaLinkedinIn className="fa-fw lh-base" /></Link></li>
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-youtube" to="">
