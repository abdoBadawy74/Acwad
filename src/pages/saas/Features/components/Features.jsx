import { BsArrowRight, BsPatchCheckFill, BsDiagram3, BsBoxes, BsPeople, BsShieldCheck, BsGear, BsPieChart, BsFunnel, BsCheck, BsBasket } from 'react-icons/bs';
              ...
              <div className="bg-light rounded-pill p-2">
                <Nav variant='pills' className="nav-pills-primary nav-responsive justify-content-between">
                  ...
                  <Nav.Item className="position-relative">
                    <span className="badge text-bg-danger position-absolute top-0 start-100 translate-middle mt-n2 ms-n5 d-none d-lg-block">Coming soon</span>
                  ...
                  <Row className="align-items-center">
                    ...
                    <Col lg={4} className="position-relative ms-auto">
                      ...
                      <div className="d-inline-block bg-white shadow rounded-4 position-absolute end-0 bottom-0 p-3 mb-n5 me-lg-n6 d-none d-sm-block">
                        <img src={trustPilotImg} className="h-20px mb-2" alt="Client-img" />
                        <div className="d-flex align-items-center">
                          <img src={trustStarImg} className="h-30px" alt="rating-img" />
